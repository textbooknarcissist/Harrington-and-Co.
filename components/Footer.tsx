...
const Footer: React.FC = () => {
  return (
    <footer className="bg-[#0F1E2E] text-[#F7F5F0] pt-16 pb-8 border-t border-white/5">
          ...
          <div className="space-y-6 order-last lg:order-first">
            <div>
              ...
              <div className="space-y-4">
                <a href="mailto:mfredebel@gmail.com" className="group flex items-center gap-4 py-2 border-b border-white/5 hover:border-[#C6A75E]/30 transition-all">
                  ...
                  <div>
                    ...
                    <span className="block text-xs font-medium group-hover:text-[#C6A75E] transition-colors">mfredebel@gmail.com</span>
                  </div>
                </a>
                
                <a href="tel:09065624016" className="group flex items-center gap-4 py-2 border-b border-white/5 hover:border-[#C6A75E]/30 transition-all">
                  <div className="w-8 h-8 bg-white/5 flex items-center justify-center rounded-sm group-hover:bg-[#C6A75E]/10">
                  ...
                  <div>
                    ...
                    <span className="block text-xs font-medium group-hover:text-[#C6A75E] transition-colors">09065624016</span>
                  </div>
                </a>
              </div>
            </div>
          ...
          <div className="lg:pl-10">
            ...
            <ul className="space-y-3">
              {['Home', 'About Us', 'Practice Areas', 'Resources', 'Contact'].map((item) => {
                ...
                return (
                  <li key={item}>
                    <a href={href} className="text-xs text-[#F7F5F0]/50 hover:text-[#C6A75E] transition-all duration-300 flex items-center group">
                      {item}
                    </a>
                  </li>
                );
          ...
          <div className="lg:pl-5">
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={item.name}>
                  <a href={item.href} className="text-xs text-[#F7F5F0]/50 hover:text-[#C6A75E] transition-all duration-300 flex items-center justify-between group">
                    {item.name}
